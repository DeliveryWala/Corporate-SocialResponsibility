...
public class RegisterActivity extends AppCompatActivity
{
    ...
    private void initUI()
    {PhoneNumberField = (EditText) findViewById( R.id.PhoneNumberField );emailField = (EditText) findViewById( R.id.emailField );nameField = (EditText) findViewById( R.id.nameField );passwordField = (EditText) findViewById( R.id.passwordField );
